...
@NoArgsConstructor
@AllArgsConstructor
public class LinePayReq implements LLPayRequest<LinePayResp> {
    ...
    public String validate() {
        ...
        if (!Arrays.asList("NORMAL_ALL", "NORMAL_BALANCE", "NORMAL_CREDIT",
                "DIGITAL_ALL", "DIGITAL_BALANCE", "DIGITAL_CREDIT").contains(payment_method)) {
