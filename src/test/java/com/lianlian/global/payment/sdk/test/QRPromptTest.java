 ...
 * @since 1.0
 */
public class QRPromptTest extends BaseTest {

    @Test
    public void apply() {

        QRPromptReq request = QRPromptReq.builder().version("v1")
        ...
        LLPayResult<QRPromptResp> applyResult = payClient.execute(request);
